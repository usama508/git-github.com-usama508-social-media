...
const navigation = [
  ...
  { name: 'Groups', href: '/groups', icon: MdGroups, current: false },
  { name: 'Market place', href: '/marketplace', icon: HiShoppingCart, current: false },
  { name: 'Watch', href: '/watch', icon: RiVideoLine, current: false },
  { name: 'Events', href: '/event', icon: MdEventNote, current: false },
      ...
      */}
      <div>
        ...
        <div className="flex flex-col lg:pl-64">
                            ...
                            <div className="flex items-center space-x-4">
                              ...
                              <div className="flex-1 min-w-0">
                                <p className="text-sm font-medium text-gray-900 truncate dark:text-white">
                                  Zawar Ahmad and 32 other people
                                </p>
                          ...
                          <li className="py-3 sm:py-4">
                            <div className="flex items-center space-x-4">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-gray-500 truncate dark:text-gray-400">
                                  mentioned you in a comment in post
                                </p>
                              </div>
                              <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
          ...
          <main className="flex-1 bg-gray-200"><div className="py-6">
            <div className=' flex '>
              
                <div className="m-auto lg:w-4/5  max-w-7xl px-4 sm:px-6 lg:px-8">

                  <CreatePost />
                  <Post />
                  {/*<Rightbar className="w-1/2 text-right"/>*/}
                </div>
                {/*<div className=' float-right lg:w-3/12 md:hidden  lg:mr-64'>
                  <Rightbar />
                              </div>*/}
              </div>
